...
import { Heart, Construction, DollarSign } from "lucide-react";
      ...
      <div className="mx-auto max-w-7xl gap-14 px-5 sm:px-8 lg:grid-cols-2 lg:gap-20 grid">
        <div>
          ...
          <div className="mt-8 space-y-6 text-base text-muted-foreground leading-relaxed">
            <p>Il <strong>Fondo Eredità</strong> non è solo un progetto sportivo, ma un patto generazionale con la nostra comunità. Crediamo che il Gaston Villa FC abbia il dovere di restituire valore al territorio che sostiene la squadra ogni giorno.</p>
            <p>Ogni euro raccolto attraverso le donazioni spontanee e i contributi dei nostri partner viene interamente reinvestito in tre pilastri fondamentali: la riqualificazione dei campetti di quartiere, il finanziamento di borse di studio sportive e la creazione di strutture ricreative gratuite per i giovani.</p>
          </div>
