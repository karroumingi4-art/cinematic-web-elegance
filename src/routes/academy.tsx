        ...
        <div className="mt-16 grid gap-12 lg:grid-cols-[1fr_1.2fr] lg:items-center lg:gap-16">
            ...
            <Reveal delay={0.05}>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">L'importo intero è di <strong>euro 450,00 €</strong> per l'intera stagione sportiva.</p>
                </div>
              </div>
            </Reveal>
            <Reveal delay={0.1}>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">La quota include tutti gli allenamenti, il tesseramento ufficiale F.I.G.C. e la copertura assicurativa completa.</p>
                </div>
              </div>
            </Reveal>
            <Reveal delay={0.15}>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">I ragazzi sono ammessi agli allenamenti nel periodo che intercorre tra l'iscrizione e il completamento del tesseramento.</p>
                </div>
              </div>
            </Reveal>
          </div>
          ...
          <Reveal delay={0.1}>
            <div className="rounded-2xl border border-border bg-surface p-8 text-center shadow-elegant sm:p-10">
              ...
              <p className="mt-4 text-sm text-muted-foreground">Scarica, compila in stampatello o compila direttamente online il documento ufficiale.</p>
              
              <div className="mt-8 flex flex-col gap-3">
                <Link
                  to="/iscrizione"
                  className="inline-flex min-h-12 items-center justify-center gap-3 rounded-full bg-primary px-8 text-[0.75rem] font-bold uppercase tracking-[0.2em] text-primary-foreground transition-all hover:shadow-glow"
                >
                ...
                <a
                  ...
                  className="inline-flex min-h-12 items-center justify-center gap-3 rounded-full border border-border bg-transparent px-8 text-[0.75rem] font-bold uppercase tracking-[0.2em] text-foreground transition-all hover:bg-zinc-900"
                >
